  ...
  return (
    <div style={{ padding: '24px', backgroundColor: 'var(--bg)', minHeight: '100vh', color: 'var(--text)', display: 'flex', flexDirection: 'column', justifyContent: 'center', boxSizing: 'border-box' }}>
      <div style={{ textAlign: 'center', marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Personalize seu perfil para começar a explorar a CONEXA.</p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '24px' }}>
        ...
        <textarea 
          ...
          rows={3}
          style={{ padding: '14px', borderRadius: '10px', backgroundColor: 'var(--surface)', border: '1px solid var(--border)', color: '#FFF', width: '100%', boxSizing: 'border-box', resize: 'none' }} 
        />
      </div>
